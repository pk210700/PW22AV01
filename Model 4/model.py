...
if __name__ == '__main__':
    ...
    for region in model.regions:
        ...
        train_mit=np.load('D:/Datasets/CelebDF v2/6_Train_Data/mit.npy')
        train_y=np.load('D:/Datasets/CelebDF v2/6_Train_Data/y.npy')
        #data = np.load(path)
        train_name=np.load('D:/Datasets/CelebDF v2/6_Train_Data/name.npy')
        train_images = train_mit#data['train_images']
        train_labels = train_y#data['train_labels']
        train_names = train_name#data['train_names']
